...
\stilian{Extensions of the results to other error models are presented in Section \ref{suppsec:other-boundaries}.}{
\fbox{But, we may bring them back if eliminating the proofs from Ch. 6 gives us enough space!}}
...
According to Lemma \ref{lemma:risk-exact-recovery-probability}, in order to study the asymptotic behaviors of 
...
\stilian{It should be noted that the URS condition is fundamentally weaker than the conventional ``mixing conditions'' employed in the analysis of sums and averages.  This is because the key to exact support recovery is the study of extremes
(viz maxima) which have fundamentally different behavior than sums, under dependence.  More insights and transparent characterizations of the dependence conditions under which the phase transition type result holds will be established in the Chapter \ref{chap:URS}.}{\fbox{check}}
...
\input{4.exact_support_recovery/4.minimax.tex}
