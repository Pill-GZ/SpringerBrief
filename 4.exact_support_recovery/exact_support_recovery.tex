...
More importantly, since the Hamming loss is the same for both independent and dependent data, typical Hamming loss-minimax studies
amount to the analysis of the elementary case of iid data. This prevents one from fully exploring the phase transition phenomena under 
other dependence conditions.
