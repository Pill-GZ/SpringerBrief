...
More importantly, despite their elegance, these Hamming loss-minimax studies naturally \stilian{replace ``amounts" by ``reduce"}{amounts} to the analysis of the elementary case of iid data, and is by design blind to non-trivial error-dependence structures.
...
\input{4.exact_support_recovery/4.Exercises.tex}
