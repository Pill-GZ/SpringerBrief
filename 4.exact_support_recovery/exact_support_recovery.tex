...
More importantly, despite their elegance, these Hamming loss-minimax studies naturally \stilian{reduce}{\xout{amounts}} to the analysis of the elementary case of iid data, and is by design blind to non-trivial error-dependence structures.
