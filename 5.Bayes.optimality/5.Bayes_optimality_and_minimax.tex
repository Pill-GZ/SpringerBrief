...
\stilian{\fbox{COMMENT} Just like for the likelihood thresholding procedure, we should be more careful about the ties and how to define
the oracle thresholding procedure so that $\widehat{S}^*$ has exactly $s$ elements.  I propose the following change}{\, }
