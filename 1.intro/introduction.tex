...
\stilian{for the large class of thresholding procedures.}{}
...
\stilian{
In Chapter \ref{chap:optimality} we study the universality of the phase-transition phenomenon in exact support recovery.  We do so by first 
establishing the finite-sample Bayes optimality and sub-optimality of thresholding procedures.  This, combined with the results from Chapter \ref{chap:exact-support-recovery}, culminates in asymptotic minimax characterizations of the phase transition phenomenon in exact 
support recovery across all procedures and/or for large class of dependence structures.}{}
