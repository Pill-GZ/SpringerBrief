...
\medskip
{\bf Signal detection.}
The asymptotic behavior of the statistical risk in signal detection problems \eqref{eq:risk-detection} in high dimensions was first studied by \stilian{Yurii Ismailovich Ingster}{where did you find the full name?} in the context of sparse additive models \eqref{eq:model-additive} with 
