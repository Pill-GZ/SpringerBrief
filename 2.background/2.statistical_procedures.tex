...
\stilian{Replacing $S$ with $T$}{\fbox{Pls check}}
...
Assuming the same one-sided alternative, let \stilian{Replacing $p(i)$ with $v(i)$ to avoid confusing with $p$}{\fbox{pls check}}
\begin{equation}
...
\stilian{Each of the above statistics $L_q, T, M,$ or $HC$, gives rise to a decision rule, whereby the null hypothesis is rejected if 
...
\citep[see also Theorem 1.2 in ][]{donoho2004higher}.}{\fbox{added} Agree?} The performance of these statistics in high-dimensional 
...
\stilian{DISCUSS}{Again, explain in the Supplement?} Variations of this procedure have been proposed to control the \ac{FDR} under \stilian{certain models of}{\fbox{added} correct?} dependent observations \citep{benjamini2001control}.
