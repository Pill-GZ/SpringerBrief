...
\subsection{Auxiliary facts of Gaussian distributions}
\label{sec:Gaussian-distributions}
\input{3.phase_transitions/3.Gaussian-distributions.tex}

\subsection{Monotonicity of the Benjamini-Hochberg procedure}
\label{suppsec:BH-monotonicity}
\input{3.phase_transitions/3.BH_monotonicity.tex}

\subsection{Proof of Theorem \ref{thm:detection-optimality}}
...
\subsection{Proof of Theorem \ref{thm:Gaussian-error-approx-boundary}}
...
\subsection{Proof of Theorems \ref{thm:Gaussian-error-exact-approx-boundary} and \ref{thm:Gaussian-error-approx-exact-boundary}}
