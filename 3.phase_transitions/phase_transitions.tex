...
\stilian{It should be noted that here we consider only the ``classic'' setting where the non-null signals are constant.  The recent contribution of \cite{li2020optimality}
investigates a more practical setting where the signals can be drawn from a general distribution with potentially heavier tail than the distribution of the additive
errors.  This leads to new phenomena such as an improved performance of the max-statistic in the detection problem.  The study of this more general setting
in both the detection and support recovery problems is an important problem of future research not covered in this monograph.}{}
