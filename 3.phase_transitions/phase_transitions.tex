...
\begin{equation} \label{eq:signal-sparsity-additive}
   |S_p| = \lfloor p^{1-\beta} \rfloor, \quad \beta\in(0,1],
\end{equation}
where $\beta$ parametrizes the problem sparsity.\stilian{A more general parameterization of the support involving a slowly 
varying function is considered in Chapter \ref{chap:exact-support-recovery}.}{} 

The closer $\beta$ to 1, the sparser the support $S_p$. Conversely, when $\beta$ is close to 0, the support is dense with many non-null signals.
