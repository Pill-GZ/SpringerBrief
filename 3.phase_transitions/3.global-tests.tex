...
\begin{figure}
      \centering
      \includegraphics[width=0.7\textwidth]{figures/theoretical_boundaries/phase_diagram_signal_detection.eps}
      \includegraphics[width=0.7\textwidth]{figures/theoretical_boundaries/phase_diagram_signal_detection_vanishing_signals.eps}
...
To the best of our knowledge, the performance of simple statistics such as $L_1$, $L_2$ norms, and 
