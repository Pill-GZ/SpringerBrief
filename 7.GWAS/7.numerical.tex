...
\stilian{These results can provide further guidance to practitioners on when to expect genetic association discoveries.
They provide also an explanation of the empirically observed phenomenon known as steep part of the power curve
in statistical genetics \citep{bush2012genome}. }{\fbox{IS this the RIGHT reference?  I could not find the ``steep part of the power curve" anywhere.}}
