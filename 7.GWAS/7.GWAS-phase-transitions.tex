...
\begin{figure}
      \centering
      \includegraphics[width=0.49\textwidth]{figures/OR-RAF_plots/OR-RAF_p4.png}
      \includegraphics[width=0.49\textwidth]{figures/OR-RAF_plots/OR-RAF_p1e2.png}
      \includegraphics[width=0.49\textwidth]{figures/OR-RAF_plots/OR-RAF_p1e6.png}
      \includegraphics[width=0.49\textwidth]{figures/OR-RAF_plots/OR-RAF_BC_study.png}
