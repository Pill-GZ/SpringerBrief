...
More general parameterizations of the support size are possible as in \eqref{eq:sparsity-parametrized}. 
Here, however, we drop the slowly varying term $\ell(\cdot)$ for simplicity.
